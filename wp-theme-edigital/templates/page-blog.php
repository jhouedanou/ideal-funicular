...
<?php
$featured = get_field('blog_featured_posts');
if ( $featured ) :
    foreach ( $featured as $post ) : setup_postdata( $post ); ?>
<li class="mb-20" style="display: flex; gap: 15px; align-items: flex-start;">
<?php if ( has_post_thumbnail( $post ) ) : ?>
<img alt="<?php echo esc_attr( get_the_title( $post ) ); ?>" src="<?php echo esc_url( get_the_post_thumbnail_url( $post, 'thumbnail' ) ); ?>" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px;"/>
<?php endif; ?>
<div>
<a href="<?php echo esc_url( get_permalink( $post ) ); ?>" style="text-decoration: none; color: #000; font-weight: 600; display: block; line-height: 1.2;"><?php echo esc_html( get_the_title( $post ) ); ?></a>
...
<div>
<a href="<?php echo esc_url( home_url( '/blog-single/' ) ); ?>" style="text-decoration: none; color: #000; font-weight: 600; display: block; line-height: 1.2;">Développement mobile : Les tendances 2024</a>
<div style="font-size: 13px; color: #747474; margin-top: 5px; display: flex; align-items: center; gap: 10px;">
...
<div>
<a href="<?php echo esc_url( home_url( '/blog-single/' ) ); ?>" style="text-decoration: none; color: #000; font-weight: 600; display: block; line-height: 1.2;">Pourquoi le SMMA est indispensable</a>
<div style="font-size: 13px; color: #747474; margin-top: 5px; display: flex; align-items: center; gap: 10px;">
...
<div>
<a href="<?php echo esc_url( home_url( '/blog-single/' ) ); ?>" style="text-decoration: none; color: #000; font-weight: 600; display: block; line-height: 1.2;">SEO : Dominer les résultats de recherche</a>
<div style="font-size: 13px; color: #747474; margin-top: 5px; display: flex; align-items: center; gap: 10px;">
...
if ( $cats ) :
    foreach ( $cats as $cat ) : ?>
<li class="mb-10"><a href="<?php echo esc_url( get_category_link( $cat->term_id ) ); ?>" style="text-decoration: none; color: #000; display: flex; justify-content: space-between;"><?php echo esc_html( $cat->name ); ?> <span>(<?php echo (int) $cat->count; ?>)</span></a></li>
<?php endforeach;
else : ?>
