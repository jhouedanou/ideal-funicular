...
// Chemin local des assets : on cherche d'abord dans le thème actif,
// puis on retombe sur la racine du repo (où index.html vit).
$assets_dir = get_template_directory() . '/assets/images/slider/';
if ( ! is_dir( $assets_dir ) ) {
    $assets_dir = dirname( ABSPATH ) . '/assets/images/slider/';
}
    ...
    if ( $slide_data['type_media'] === 'image' ) {
        ...
        if ( $attachment ) {
            ...
            if ( file_exists( $local_path ) ) {
                ...
                // media_handle_sideload() déplace tmp_name -> uploads. On
                // copie d'abord vers un fichier temporaire pour préserver
                // la source dans le thème.
