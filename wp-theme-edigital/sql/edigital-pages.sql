...
<!-- wp:edigital/expertise-grid {"titre":"Notre Expertise","texteCta":"Découvrez nos dernières réalisations","libelleCta":"Voir Tous Les Projets","lienCta":"/nos-projets/"} -->
	<!-- wp:edigital/expertise-card {"titre":"Conception de site vitrine","categorie":"Web Design","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Développement E-commerce","categorie":"E-commerce","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Application Mobile Native","categorie":"Développement Mobile","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Référencement SEO / SEA","categorie":"Marketing Digital","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Création d''Identité Visuelle","categorie":"Branding & Design","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Maintenance & Hébergement","categorie":"Support Technique","lien":"/projet/"} /-->
