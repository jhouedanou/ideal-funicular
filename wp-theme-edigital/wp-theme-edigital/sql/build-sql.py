...
PAGES = [
    ...
    },
    {
        ...
        "title": "Nos Services",
        "menu_order": 2,
        "builder": lambda f="services.html": build_from_fixture(f),
    },
    {
        ...
        "builder": lambda f="service-creation-web.html": build_from_fixture(f),
    },
    {
        ...
        "menu_order": 4,
        "parent_slug": "services",
        "builder": lambda f="service-mobile-native.html": build_from_fixture(f),
    },
    {
        ...
        "menu_order": 5,
        "parent_slug": "services",
        "builder": lambda f="service-app-metier.html": build_from_fixture(f),
    },
    {
        ...
        "menu_order": 6,
        "parent_slug": "services",
        "builder": lambda f="service-branding.html": build_from_fixture(f),
    },
    {
        ...
        "menu_order": 7,
        "parent_slug": "services",
        "builder": lambda f="service-visibilite-seo.html": build_from_fixture(f),
    },
    {
        ...
        "menu_order": 8,
        "parent_slug": "services",
        "builder": lambda f="service-visibilite-google-ads.html": build_from_fixture(f),
    },
    {
        ...
        "menu_order": 9,
        "parent_slug": "services",
        "builder": lambda f="service-maintenance.html": build_from_fixture(f),
    },
    {
        "slug": "nos-technologies",
        "title": "Nos Technologies",
        "menu_order": 10,
        "builder": lambda f="nos-technologies.html": build_from_fixture(f),
    },
    {
        "slug": "nos-projets",
        "title": "Nos Projets",
        "menu_order": 11,
        "builder": lambda f="nos-projets.html": build_from_fixture(f),
    },
    {
        "slug": "blog",
        "title": "Blog",
        "menu_order": 12,
        "page_for_posts": True,
        "builder": lambda f="blog.html": build_from_fixture(f),
    },
    {
        "slug": "contact",
        "title": "Contact",
        "menu_order": 13,
        "builder": lambda f="contact.html": build_from_fixture(f),
    },
]
