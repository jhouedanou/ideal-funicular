...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/ChatGPT Image 23 mars 2026, 16_40_14.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"","breadcrumb2Url":"","breadcrumbCurrent":"Nos Services","titre":"Nos Services","sousTitre":"Des solutions sur-mesure pour donner vie à vos projets et propulser votre entreprise dans l''ère digitale."} /-->
...
{"titre":"Solution Numérique","description":"Développement de sites vitrines et e-commerce ultra-performants. Un design premium et une ergonomie pensée pour convertir vos visiteurs en clients.","url":"/service-creation-web/","imageUrl":"/wp-content/themes/edigital/assets/images/service-web-hero.jpg"},
{"titre":"Audit Visibilité","description":"Analyse approfondie et optimisation de votre présence sur les moteurs de recherche. Générez un trafic qualifié et pérenne grâce au SEO.","url":"/service-visibilite-seo/","imageUrl":"/wp-content/themes/edigital/assets/images/hero-visibilite.png"},
{"titre":"Publicité Google et Meta","description":"Campagnes publicitaires ciblées sur Google Ads et les réseaux sociaux. Maximisez votre ROI avec des annonces ultra-performantes.","url":"/service-visibilite-google-ads/","imageUrl":"/wp-content/themes/edigital/assets/images/hero-ads.png"},
{"titre":"Application Métier","description":"Développement de logiciels sur-mesure pour automatiser et digitaliser vos processus internes. Des outils robustes adaptés à vous.","url":"/service-app-metier/","imageUrl":"/wp-content/themes/edigital/assets/images/hero-app-metier.png"},
{"titre":"Branding & Design","description":"Création d''identités visuelles puissantes, logotypes et chartes mémorables. Conception d''interfaces UI/UX centrées utilisateur.","url":"/service-branding/","imageUrl":"/wp-content/themes/edigital/assets/images/hero-branding.png"},
{"titre":"Maintenance & Support","description":"Hébergement sécurisé, mises à jour critiques et support technique dédié. Garantissez la pérennité de vos actifs numériques.","url":"/service-maintenance/","imageUrl":"/wp-content/themes/edigital/assets/images/hero-maintenance.png"}
]} /-->

<!-- wp:edigital/text-ticker {"separateurUrl":"/wp-content/themes/edigital/assets/images/portfolio/circle-mokko.svg","ligne1":[{"avant":"SITES","mot":"WEB","apres":"SUR MESURE"},{"avant":"APPLICATIONS","mot":"MOBILES","apres":""},{"avant":"LOGICIELS","mot":"MÉTIER","apres":""},{"avant":"SOLUTION","mot":"SMMA","apres":""},{"avant":"SITES","mot":"E-COMMERCE","apres":""}],"ligne2":[{"avant":"SEO &","mot":"STRATÉGIE","apres":"DIGITALE"},{"avant":"DESIGN","mot":"PREMIUM","apres":""},{"avant":"ACCOMPAGNEMENT","mot":"DÉDIÉ","apres":""},{"avant":"INNOVATION","mot":"TECH","apres":""},{"avant":"EXPERTISE","mot":"WEB","apres":""}]} /-->

<!-- wp:edigital/service-cta {"titre":"Prêt à lancer votre projet ?","texte":"Discutons ensemble de vos besoins et construisons la solution qui propulsera votre activité.","libelleCta":"Discutons de votre projet","lienCta":"/contact/"} /-->',
  'Nos Services',
  '',
  'publish', 'closed', 'closed', '',
  'services',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/service-web-hero.jpg","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"Création Site Web","titre":"Création de Site Web","sousTitre":"Des sites modernes, réactifs et optimisés SEO, conçus pour convertir vos visiteurs en clients."} /-->
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/service-web-hero.jpg","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"App Mobile","titre":"Applications Mobiles Natives","sousTitre":"Offrez une expérience utilisateur exceptionnelle sur iOS et Android."} /-->
...
<!-- wp:edigital/text-ticker {"separateurUrl":"/wp-content/themes/edigital/assets/images/portfolio/circle-mokko.svg","ligne1":[{"avant":"APPLICATIONS","mot":"NATIVES","apres":""},{"avant":"iOS &","mot":"ANDROID","apres":""},{"avant":"FLUTTER /","mot":"REACT","apres":"NATIVE"},{"avant":"APP","mot":"STORE","apres":""}],"ligne2":[{"avant":"PERFORMANCE","mot":"PREMIUM","apres":""},{"avant":"UX","mot":"INTUITIVE","apres":""},{"avant":"PUSH","mot":"NOTIFICATIONS","apres":""},{"avant":"EXPERTISE","mot":"MOBILE","apres":""}]} /-->

<!-- wp:edigital/service-cta {"titre":"Prêt à lancer votre application ?","texte":"Discutons ensemble de vos besoins et construisons l''application mobile qui engagera vos utilisateurs.","libelleCta":"Parlons de votre application","lienCta":"/contact/"} /-->',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/hero-app-metier.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"Application Métier","titre":"Applications Métier : L''outil sur-mesure pour votre performance","sousTitre":"Vos processus internes sont ralentis par des fichiers Excel complexes ou des logiciels rigides ? Pour franchir un cap, votre entreprise a besoin d''outils qui s''adaptent à votre manière de travailler, et non l''inverse."} /-->

<!-- wp:edigital/service-intro {"titre":"Pourquoi passer au sur-mesure ?"} /-->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Une application métier n''est pas un gadget, c''est le moteur de votre productivité :</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Développer une application efficace demande une compréhension profonde des enjeux business. Avec plus de dix ans d''expérience, E-Digital conçoit des solutions robustes et intuitives qui transforment votre organisation quotidienne en avantage concurrentiel.</p>
<!-- /wp:paragraph -->
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/hero-branding.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"Branding & Design","titre":"Branding & Design : Soyez mémorable, soyez leader","sousTitre":"Votre identité visuelle est la première promesse que vous faites à vos clients. Si votre image est datée ou floue, vous perdez en crédibilité avant même d''avoir pris la parole. Le branding, c''est l''art de transformer votre expertise en une marque forte et reconnaissable."} /-->

<!-- wp:edigital/service-intro {"titre":"Au-delà du simple logo"} /-->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Nous créons des univers de marque qui captent l''attention et inspirent la confiance :</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Une marque forte est un actif qui prend de la valeur. Avec plus de dix ans d''expérience, E-Digital conçoit des identités visuelles pérennes, capables de soutenir les besoins de votre croissance sur le long terme.</p>
<!-- /wp:paragraph -->
...
<!-- wp:edigital/service-cta {"titre":"Donnez à votre ambition l''image qu''elle mérite","texte":"Ne laissez plus une image médiocre freiner votre développement.","libelleCta":"Demander un devis","lienCta":"/contact/"} /-->',
  'Branding & Design',
  '',
  'publish', 'closed', 'closed', '',
  'service-branding',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/hero-visibilite.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"Visibilité","titre":"Votre site existe, mais reste invisible ?","sousTitre":"Un site sans trafic est un investissement perdu. Si votre plateforme ne génère ni contacts ni ventes, ce n''est pas un problème de design, c''est un problème de visibilité."} /-->

<!-- wp:edigital/service-intro {"titre":"E-Digital.fr : L''expérience au service de votre croissance"} /-->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Ne laissez plus vos concurrents prendre toute la place. Nous transformons votre site en un véritable levier de business.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center","className":"has-strong-emphasis"} -->
<p class="has-text-align-center has-strong-emphasis"><strong>Le constat est simple : votre croissance de demain dépend de votre visibilité d''aujourd''hui.</strong></p>
<!-- /wp:paragraph -->
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/hero-ads.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"Publicité Google et Meta","titre":"Publicité Google & Meta : Dominez votre marché","sousTitre":"Vous voulez des résultats immédiats ? Là où le SEO prend des mois, la publicité payante (Google Ads & Meta Ads) vous propulse en tête de liste en 24 heures."} /-->

<!-- wp:edigital/service-intro {"titre":"Pourquoi coupler Google et Meta ?"} /-->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">C''est l''alliance parfaite pour couvrir 100% du parcours de vos clients :</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Gérer des budgets publicitaires ne s''improvise pas. Avec plus de dix ans d''expérience, nous optimisons chaque euro investi pour garantir votre rentabilité.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong>Stop aux budgets gaspillés. Passez à une stratégie publicitaire qui transforme vos investissements en chiffre d''affaires.</strong></p>
<!-- /wp:paragraph -->
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/hero-maintenance.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"Services","breadcrumb2Url":"/services/","breadcrumbCurrent":"Maintenance & Support","titre":"Maintenance : Sécurisez votre actif numérique","sousTitre":"Un site ou une application qui tombe, c''est une perte immédiate de chiffre d''affaires et de crédibilité. La technologie évolue chaque jour : ne laissez pas l''obsolescence ou une faille technique paralyser votre entreprise."} /-->

<!-- wp:edigital/service-intro {"titre":"Zéro interruption, 100% de sérénité"} /-->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Nous ne nous contentons pas de réparer ; nous anticipons. Notre service de maintenance garantit la pérennité de vos outils :</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">S''appuyer sur E-Digital, c''est bénéficier de plus de dix ans d''expérience dans la gestion d''infrastructures critiques. Nous assurons la surveillance de vos plateformes pour que vous puissiez vous concentrer sur l''essentiel : vos besoins de croissance.</p>
<!-- /wp:paragraph -->
...
<!-- wp:edigital/service-cta {"titre":"Ne prenez aucun risque avec vos plateformes","texte":"Découvrez nos plans de maintenance sur-mesure pour vous sécuriser dès aujourd''hui.","libelleCta":"Demander un devis","lienCta":"/contact/"} /-->',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/ChatGPT Image 23 mars 2026, 16_40_14.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"","breadcrumb2Url":"","breadcrumbCurrent":"Nos Technologies","titre":"Nos Technologies","sousTitre":"Nous maîtrisons les outils les plus performants pour donner vie à vos projets les plus ambitieux."} /-->

<!-- wp:edigital/service-intro {"titre":"Une stack moderne et éprouvée pour bâtir des solutions performantes."} /-->

<!-- wp:edigital/technos-grid {"items":[
{"label":"Flutter","description":"Développement mobile multiplateforme haute performance pour iOS et Android avec un code unique.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flutter/flutter-original.svg"},
{"label":"React Native","description":"Applications mobiles natives puissantes utilisant la flexibilité et la rapidité de React.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg"},
{"label":"WordPress","description":"Création de sites vitrines et blogs dynamiques, optimisés pour un référencement naturel maximal.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/wordpress/wordpress-plain.svg"},
{"label":"Prestashop","description":"Solutions e-commerce robustes et évolutives pour gérer vos ventes en ligne en toute simplicité.","iconUrl":"/wp-content/themes/edigital/assets/images/portfolio/blog-ecommerce.png"},
{"label":"Laravel","description":"Développement de plateformes web complexes et de logiciels métiers sécurisés sur mesure.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-original.svg"},
{"label":"Python & IA","description":"Automatisation intelligente et intégration de solutions d''intelligence artificielle avancées.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg"},
{"label":"Next.js","description":"Interfaces utilisateur ultra-rapides et optimisées pour le SEO avec les dernières innovations React.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg"},
{"label":"Tailwind CSS","description":"Design moderne, réactif et épuré pour une expérience utilisateur exceptionnelle sur tous les écrans.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg"},
{"label":"Node.js","description":"Backend temps réel ultra-rapide pour des applications web modernes et scalables.","iconUrl":"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg"}
]} /-->

<!-- wp:edigital/text-ticker {"separateurUrl":"/wp-content/themes/edigital/assets/images/portfolio/circle-mokko.svg","ligne1":[{"avant":"FLUTTER &","mot":"REACT","apres":"NATIVE"},{"avant":"WORDPRESS","mot":"PREMIUM","apres":""},{"avant":"LARAVEL","mot":"PHP","apres":""},{"avant":"NEXT.JS","mot":"REACT","apres":""}],"ligne2":[{"avant":"PYTHON &","mot":"IA","apres":""},{"avant":"NODE.JS","mot":"BACKEND","apres":""},{"avant":"TAILWIND","mot":"CSS","apres":""},{"avant":"PRESTASHOP","mot":"E-COMMERCE","apres":""}]} /-->

<!-- wp:edigital/service-cta {"titre":"Une technologie pour chaque ambition","texte":"Parlons de votre projet : nous choisirons ensemble la stack la mieux adaptée à vos enjeux.","libelleCta":"Discuter de votre projet","lienCta":"/contact/"} /-->',
  'Nos Technologies',
  '',
  'publish', 'closed', 'closed', '',
  'nos-technologies',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/most-hero.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"","breadcrumb2Url":"","breadcrumbCurrent":"Nos Projets","titre":"Nos Projets","sousTitre":"Découvrez nos dernières réalisations et laissez-vous inspirer pour votre futur projet digital."} /-->

<!-- wp:edigital/projets-intro {"titre":"Agence digitale spécialisée dans la conception et le développement de solutions sur mesure.","sousTitre":"Filtrez par typologie pour explorer nos références.","filtres":[{"label":"Tous nos projets","slug":"*"},{"label":"Design","slug":"design"},{"label":"Développement","slug":"developpement"},{"label":"Portfolio","slug":"portfolio"}]} /-->

<!-- wp:edigital/expertise-grid {"titre":"Une sélection de réalisations","texteCta":"Un projet à nous confier ?","libelleCta":"Demander un devis","lienCta":"/contact/"} -->
	<!-- wp:edigital/expertise-card {"titre":"Logic Design Solutions","categorie":"Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/LDSolutions.png","imageAlt":"Logic Design Solutions","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Quitus Immobilier","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/Design-sans-titre-2-e1732180073249.jpg","imageAlt":"Quitus Immobilier","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Pouret Medical","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/Design-sans-titre-3-e1732180334178.jpg","imageAlt":"Pouret Medical","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Ruaud Industries","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/Design-sans-titre-4-e1732204171914.jpg","imageAlt":"Ruaud Industries","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Yvanick Conseil","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/Design-yvanik.jpg","imageAlt":"Yvanick Conseil","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Bike Service","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/bike-service-developpeur-ulrich-kouame.webp","imageAlt":"Bike Service","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Dupain","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/Design-dupain.jpg","imageAlt":"Dupain","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Fer Play","categorie":"Design | Développement","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/Design-sans-titre-5-e1732204755993.jpg","imageAlt":"Fer Play","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Cabinet FAMCHON","categorie":"Développement | Portfolio","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/cabinet-famchon-developpeur-ulrich-kouame.webp","imageAlt":"Cabinet FAMCHON","lien":"/projet/"} /-->
	<!-- wp:edigital/expertise-card {"titre":"Maintenance PC Paris","categorie":"Développement | Portfolio","imageUrl":"/wp-content/themes/edigital/assets/images/portfolio/maintenance-pc-paris-developpeur-ulrich-kouame.webp","imageAlt":"Maintenance PC Paris","lien":"/projet/"} /-->
<!-- /wp:edigital/expertise-grid -->

<!-- wp:edigital/text-ticker {"separateurUrl":"/wp-content/themes/edigital/assets/images/portfolio/circle-mokko.svg","ligne1":[{"avant":"SITES","mot":"WEB","apres":"SUR MESURE"},{"avant":"APPLICATIONS","mot":"MOBILES","apres":""},{"avant":"LOGICIELS","mot":"MÉTIER","apres":""},{"avant":"SOLUTION","mot":"SMMA","apres":""},{"avant":"SITES","mot":"E-COMMERCE","apres":""}],"ligne2":[{"avant":"SEO &","mot":"STRATÉGIE","apres":"DIGITALE"},{"avant":"DESIGN","mot":"PREMIUM","apres":""},{"avant":"ACCOMPAGNEMENT","mot":"DÉDIÉ","apres":""},{"avant":"INNOVATION","mot":"TECH","apres":""},{"avant":"EXPERTISE","mot":"WEB","apres":""}]} /-->

<!-- wp:edigital/service-cta {"titre":"Un projet à nous confier ?","texte":"Discutons de vos enjeux et faisons de votre prochaine réalisation un cas client à part entière.","libelleCta":"Demander un devis","lienCta":"/contact/"} /-->',
  'Nos Projets',
  '',
  'publish', 'closed', 'closed', '',
  'nos-projets',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/hero-blog.png","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"","breadcrumb2Url":"","breadcrumbCurrent":"Blog","titre":"Notre Blog","sousTitre":"Actualités, conseils et tendances du monde digital pour propulser votre activité."} /-->

<!-- wp:edigital/service-intro {"titre":"Idées, expertises et retours d''expérience signés E-Digital."} /-->

<!-- wp:edigital/actualites-grid {"titre":"DERNIÈRES ACTUALITÉS","nombre":9,"colonnes":"3","libelleCta":"Toutes les actualités","lienCta":"/blog/","variante":"section"} /-->

<!-- wp:edigital/text-ticker {"separateurUrl":"/wp-content/themes/edigital/assets/images/portfolio/circle-mokko.svg","ligne1":[{"avant":"INSPIRATION","mot":"DIGITALE","apres":""},{"avant":"DESIGN","mot":"TENDANCES","apres":""},{"avant":"E-COMMERCE","mot":"INSIGHTS","apres":""},{"avant":"SEO","mot":"STRATÉGIE","apres":""}],"ligne2":[{"avant":"DÉVELOPPEMENT","mot":"WEB","apres":""},{"avant":"APP","mot":"MOBILE","apres":""},{"avant":"BRANDING","mot":"IDENTITÉ","apres":""},{"avant":"INNOVATION","mot":"TECH","apres":""}]} /-->

<!-- wp:edigital/service-cta {"titre":"Un projet à concrétiser ?","texte":"Discutons de vos besoins et trouvons ensemble la meilleure approche.","libelleCta":"Nous contacter","lienCta":"/contact/"} /-->',
  'Blog',
  '',
  'publish', 'closed', 'closed', '',
  'blog',
...
INSERT INTO wp_posts (ID, post_author, post_date, post_date_gmt, post_content, post_title, post_excerpt, post_status, comment_status, ping_status, post_password, post_name, to_ping, pinged, post_modified, post_modified_gmt, post_content_filtered, post_parent, guid, menu_order, post_type, post_mime_type, comment_count) VALUES (
  ...
  '<!-- wp:edigital/service-hero {"backgroundUrl":"/wp-content/themes/edigital/assets/images/contact-hero-bg.jpg","breadcrumb1Label":"Accueil","breadcrumb1Url":"/","breadcrumb2Label":"","breadcrumb2Url":"","breadcrumbCurrent":"Contact","titre":"Travaillons Ensemble","sousTitre":"Parlons de votre projet. Nous revenons vers vous très rapidement."} /-->

<!-- wp:edigital/service-intro {"titre":"Parlons de votre projet"} /-->
...
<!-- wp:paragraph -->
<p>Remplissez le formulaire ci-dessous : ces éléments nous permettent de préparer une étude personnalisée avant même notre premier échange.</p>
<!-- /wp:paragraph -->
...
<!-- wp:edigital/contact-info {"telLabel":"Appelez-nous","telValue":"01 84 25 16 81","emailLabel":"Écrivez-nous","emailValue":"com1@e-digital.fr","horairesLabel":"Horaires","horairesValue":"Lun – Ven : 8H à 17H30"} /-->

<!-- wp:edigital/office-card {"label":"Siège social — Paris","adresse":"23 rue du départ, 75014 Paris"} /-->

<!-- wp:edigital/office-card {"label":"Agence Yvelines","adresse":"Guyancourt (78280)"} /-->
...
<!-- wp:edigital/service-cta {"titre":"Un projet à concrétiser ?","texte":"Vous préférez nous appeler ? Nous sommes joignables au 01 84 25 16 81 du lundi au vendredi.","libelleCta":"Voir nos services","lienCta":"/services/"} /-->',
  'Contact',
  '',
  'publish', 'closed', 'closed', '',
  'contact',
